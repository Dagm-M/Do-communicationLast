  ...
  return (
    <AuthLayout title="Sign In">
      ...
      <div className="flex flex-col gap-4">
        <button onClick={handleLogin} className="w-full text-lg text-white font-semibold flex items-center justify-center bg-primary py-4 rounded-full shadow-sm shadow-black hover:brightness-95">
          Sign in
        </button>
        ...
        <button onClick={handleLoginGoogle} className="w-full text-lg text-white font-semibold flex items-center justify-center bg-primary py-4 rounded-full shadow-sm shadow-black hover:brightness-95">
